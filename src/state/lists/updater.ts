...
import { ARBITRUM_LIST, CELO_LIST, OPTIMISM_LIST, UNSUPPORTED_LIST_URLS, ZIRCUIT_LIST } from 'constants/lists'
...
export default function Updater(): null {
  ...
  useEffect(() => {
    ...
    if (chainId && [SupportedChainId.ZIRCUIT].includes(chainId)) {
