...
import { CUSD_CELO, DAI_OPTIMISM, USDC_ARBITRUM, USDC_MAINNET, USDC_POLYGON, USDC_ZIRCUIT } from '../constants/tokens'
...
export const STABLECOIN_AMOUNT_OUT: { [chainId: number]: CurrencyAmount<Token> } = {
  ...
  [SupportedChainId.ZIRCUIT]: CurrencyAmount.fromRawAmount(USDC_ZIRCUIT, 10_000e18),
}
